  ...
  return (
    ...
    >
      {variant ? (
        <div
          className={
            styles?.cardCategories__imgModal +
            ' ' +
            checkCategoryCard(title, styles)
          }
        >
          <Image
            loader={myLoader}
      ...
      >
        ...
        >
          ...
          >
            ...
            <stop offset='0.095' stopColor='#888' />
            <stop offset='0.232' stopColor='#d5d5d5' />
            <stop offset='0.552' stopColor='#797979' />
            <stop offset='0.804' stopColor='#d5d5d5' />
