    ...
    <ul className={styles?.socialmedia}>
      <li>
        <a
          ...
          rel='noreferrer'
        >
          <svg xmlns="http://www.w3.org/2000/svg" width="30px" height="27px" viewBox="0 0 33 30" version="1.1">
            <g id="surface1">
      ...
      <li>
        <a
          className={styles?.socialmedia__icon}
          href={'https://www.youtube.com/@portafolioco'}
          target='_blank'
          rel='noreferrer'
        >
          <svg xmlns="http://www.w3.org/2000/svg" width="38" height="27" viewBox="0 0 38.8 27.117">
            <path id="Icon_simple-youtube" data-name="Icon simple-youtube" d="M38,9.611A4.863,4.863,0,0,0,34.62,6.234c-3.024-.81-15.2-.81-15.2-.81s-12.141-.016-15.2.81A4.863,4.863,0,0,0,.852,9.611,50.535,50.535,0,0,0,.008,19a50.535,50.535,0,0,0,.844,9.353,4.863,4.863,0,0,0,3.377,3.377c3.021.812,15.2.812,15.2.812s12.139,0,15.2-.812A4.863,4.863,0,0,0,38,28.352,50.535,50.535,0,0,0,38.806,19,50.535,50.535,0,0,0,38,9.611ZM15.54,24.807V13.174L25.67,19Z" transform="translate(-0.007 -5.424)" />
          </svg>
        </a>
      </li>
      <li>
